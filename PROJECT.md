...
- ตรวจแล้ว: `npm run check` + `npm test` **140/140 ผ่าน** (audit v2.5.0 → กฎโหวต v2.5.1 → ปกการ์ดแจก/ซ่อนการ์ดธีม v2.5.2 → shield ปกการ์ดเท่ากันเป๊ะ v2.5.3 → S18 ครบทุกบทบาท 30/30)
...
- ✅ **Test อัตโนมัติ (E2E)** — `test/smoke.mjs` (Node + Chrome DevTools Protocol, **140 checks**, test เองไม่มี dependency) รันด้วย `npm test` — _ทำเสร็จในรอบ P1 + ขยาย S16/S17_
...
| Smoke test จริงครบทุกข้อใน `TESTING.md`                                                                                                                                                                                                                                                 | ⬜ ยังไม่ได้ทำ (แต่มี E2E 140/140 แทน)    |
